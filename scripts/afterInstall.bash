docker pull dnfla960/idu-market-server:latest
docker run --env-file /home/ubuntu/.env --publish 8080:8080 -it --detach --name idu-market-server dnfla960/idu-market-server:latest /bin/bash
