...
var WatchList = require("../../models/services/WatchList/WatchList");
var process = {
    findAllByStudentId: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var watchList, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    watchList = new WatchList(req);
                    return [4 /*yield*/, watchList.findAllByStudentId()];
                case 1:
                    response = _a.sent();
                    if (response.isError) {
    ...
    update: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    watchList = new WatchList(req);
                    return [4 /*yield*/, watchList.update()];
                case 1:
                    response = _a.sent();
                    if (response.isError) {
    ...
    delete: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    watchList = new WatchList(req);
                    return [4 /*yield*/, watchList.delete()];
                case 1:
                    response = _a.sent();
                    if (response.isError) {
