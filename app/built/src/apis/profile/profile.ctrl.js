...
var _this = this;
var Profile = require("../../models/services/Profile/Profile");
var logger = require("../../config/logger");
var process = {
    findOneById: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var profile, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Profile(req)];
                case 1:
                    profile = _a.sent();
                    return [4 /*yield*/, profile.findOneById()];
                case 2:
                    response = _a.sent();
                    if (response.isError) {
    ...
    updateImage: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var profile, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Profile(req)];
                case 1:
                    profile = _a.sent();
                    return [4 /*yield*/, profile.updateImage()];
                case 2:
                    response = _a.sent();
                    if (response.isError) {
