...
var _this = this;
var PurchaseList = require("../../models/services/PurchaseList/PurchaseList");
var logger = require("../../config/logger");
var process = {
    read: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var student, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    student = new PurchaseList(req);
                    return [4 /*yield*/, student.read()];
                case 1:
                    response = _a.sent();
                    if (response.isError) {
    ...
    create: function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var purchaseList, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    purchaseList = new PurchaseList(req);
                    return [4 /*yield*/, purchaseList.create()];
                case 1:
                    response = _a.sent();
                    if (response.isError) {
                        logger.error("POST /api/purchase-list 409 " + response.errMsg);
                        return [2 /*return*/, res.status(409).json(response.clientMsg)];
                    }
                    if (response.success) {
